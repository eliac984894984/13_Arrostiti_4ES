...
void Regole::mostra() {
    ...
    cout << "Il tabellone presenta 30 caselle e ogni giocatore ha lo scopo di raggiungere l'ultima per primo."
         << "Ogni giocatore è rappresentato da una pedina diversa, per tenere traccia della cassella in cui si trova nel tabellone. " << endl;

    cout << "Il numero di giocatori è 4, per giocare in modo più dinamico si consiglia che abbiano più di 8 anni."
    ...
    cout << "Per quanto riguarda i punti ci sono diversi modi per ottenerli. Ogni giocatore riceve 5 carte e dei segnalini voto numerati. "
         ...
         << "da questa descrizione gli altri giocatori devono consegnare, in modo coperto, al narratore una delle loro carte che corrisponda il più possibile alla descrizione fornita."
         ...
         << "Inoltre, ogni giocatore riceve 1 punto per ogni voto ricevuto alla propria carta. "
