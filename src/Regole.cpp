...
void Regole::mostra() {
    ...
    cout << "Giocatori: Nell'edizione classica di Dixit il massimo numero di giocatori è 4, ed è caldamente consigliato "
         << "rispettare il limite di età indicato, ovvero dagli 8 anni in su. "
         << "Tutto ciò può variare in base alle edizioni: Disney, Stellare, Odyssey... "<< endl;

    cout << "Punti: Ci sono diversi modi per ottenere punti. Ogni giocatore riceve 5 carte e dei segnalini voto numerati. "
