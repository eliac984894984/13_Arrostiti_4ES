...
void Mazzo_E::definisci()
{
    ...
    cartaestesa.push_back("Al centro vi e' un trono dorato circondato da un'aura su cui siede Topolino; sotto al trono c'e' Pluto e un altro Topolino che porge una corona al sovrano.");
    ...
    cartaestesa.push_back("Libro tenuto aperto da due mani umane e una zampa di Winnie the Pooh, su una pagina e' raffigurato Winnie (su questa pagina e' poggiata un'ape e da un barattolo cola del miele), l'altra pagina raffigura un albero.");
    cartaestesa.push_back("Mushu che tiene un pennello e dissegna il principe capovolto in meta' carta, nell'altra meta' un pennello disegna Mulan accerchiata da fiori rosa.");
    ...
    cartaestesa.push_back("Bolt, del film -Bolt-, seduto ad un tavolo che ammira una bistecca, sullo sfondo e' presente la gatta, Mittens.");
    ...
    cartaestesa.push_back("Carta divisa a meta' verticalmente: nella prima meta' una savana in degrado, nella seconda meta' la savana e' popolata e fertile; nel cielo e' presente il volto del Re Leone.");
    ...
    cartaestesa.push_back("Dumbo che vola con delle cicogne al tramonto. Con la proboscide tiene un fagotto con all'interno una piuma.");
    ...
    cartaestesa.push_back("Albero in una radura su cui e' afflitto un volantino con scritto: -Ricercato Flin Rider-.");
    cartaestesa.push_back("Anna ed Elsa, di *Frozen*, a cavallo che galoppano in un'atmosfera glaciale.");
    cartaestesa.push_back("Baymax, di *Big Hero 6*, sorregge una cassetta del pronto soccorso; e' di fronte a Yokai, alle cui spalle c'e' una figura costituita da microrobot. I due si trovano in un luogo buio illuminato da lanterne viola.");
    cartaestesa.push_back("Un pinguino con un papillon sorregge un vassoio sopra la testa, sul quale vi e' un bicchiere di ghiaccio con un ombrellino da cocktail.");
    ...
    cartaestesa.push_back("Tavolo, in una casa sfarzosa con un camino acceso, sul quale e' presente un piatto di spaghetti conditi con polpette, due spaghetti formano un cuore.");
    ...
    cartaestesa.push_back("Mela avvelenata di Biancaneve appoggiata sul tronco di un albero tagliato; con al di sopra una mano stregata che sta per afferrarla.");
