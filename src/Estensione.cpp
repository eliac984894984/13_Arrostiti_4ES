...
{
    cartaestesa.push_back("Alice, di alice nel paese delle meraviglie appoggiata all'orologio del bianconiglio "); // da finire
    ...
    carte.push_back("Due scarpe col tacco rosa che sono sfumate.");
    carte.push_back("Due porte rossa e blu eun coniglio che non sa dove entrare.");
    carte.push_back("Uomo con cappello in un campo di girasoli.");
    ...
    carte.push_back("Un uomo con una corona e con una gonna.");
    carte.push_back("un uomo in prigione che guarda il cielo da una finestrella.");
    carte.push_back("un uomo su un cavallo che dupera un ponte arcobaleno.");
    carte.push_back("Una pila di libri con un uomo sopra.");
    carte.push_back("Una porta che da sul vuoto.");
